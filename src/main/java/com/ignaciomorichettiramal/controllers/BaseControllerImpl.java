...
import com.ignaciomorichettiramal.services.BaseService;
...
public abstract class BaseControllerImpl<E extends Base, ID extends Serializable, S extends BaseService<E, ID>>
    ...
    public ResponseEntity<?> save(@RequestBody E entity) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("{\"error\":\"Error, por favor intente mÃ¡s tarde.\"}");
        }
    }
